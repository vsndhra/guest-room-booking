...
<div class="card" style="margin-top:15px;">
    ...
    <div class="card-body" style="padding-left: 25%; width: 70%;">
        <form method="POST" action="{{ url('create-room') }}" enctype="multipart/form-data">
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="number_of_beds" value="{{ old('number_of_beds') }}">
                    <span class="text text-danger">@error('number_of_beds') {{ $message }} @enderror</span>
                </div>
                <div class="form-group">
                    <strong>Room Rent (Rupees/Day) </strong>
                    <input class="form-control" type="text" name="room_rent" value="{{ old('room_rent') }}">
                    <span class="text text-danger">@error('room_rent') {{ $message }} @enderror</span>
                </div>
                <div class="form-group">
                    <strong>Minimum Stay (Day/Days)</strong>
                    <input class="form-control" type="text" name="min_stay" value="{{ old('min_stay') }}">
                    <span class="text text-danger">@error('min_rent') {{ $message }} @enderror</span>
                </div>
                <div class="form-group">
                    <strong>Maximum Stay (Days)</strong>
                    <input class="form-control" type="text" name="max_stay" value="{{ old('max_stay') }}">
